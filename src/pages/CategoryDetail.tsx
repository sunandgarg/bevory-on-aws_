...
const CategoryDetail = () => {
  ...
  return (
    <>
      <SEOHead
        title={(category as any).meta_title || `${category.name} - Buy Online at Best Prices | BevOry`}
        ...
        keywords={`${category.name}, buy ${category.name.toLowerCase()} online, ${category.name.toLowerCase()} prices, ${category.name.toLowerCase()} India`}
